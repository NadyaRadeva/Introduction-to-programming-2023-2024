...
int findProductElBelowSecondaryDiag(int matrix[][MAX_ROW_AND_COL_SIZE], unsigned int size);
...
int main() {
	...
	std::cout << "The product of the elements below the secondary diagonal is " << findProductElBelowSecondaryDiag(matrix, size) << "." << std::endl;
